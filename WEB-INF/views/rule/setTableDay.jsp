...
<body>
<div class="plat_box">
    <form id="inputForm" action="${ctx}/rule/setTableDay" class="layui-form" lay-filter="inputForm">
        <div class="layui-inline">
            <input type="hidden" id="type" name="type" value="1">
            <label class="layui-form-label">天数：</label>
            <div class="layui-input-inline">
                <input type="text" id="routeDeviateValue" name="routeDeviateValue" value="${map.value}"
