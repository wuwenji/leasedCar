...
<section>
	...
	<jsp:include page="/WEB-INF/layouts/left_menu.jsp"/>
		...
		<div>
			<form id="searchForm" class="layui-form" action="${ctx}/transport/user/list" method="post">
				...
				<div class="button_right">
						...
						<div class="layui-inline search_div">
							...
							<div class="layui-input-inline search_select">
								<select name="fieldName" id="fieldName" lay-filter="fieldName">
									...
									<option value="r.role_name" <c:if test="${user.fieldName eq 'r.role_name'}">
										selected="selected"</c:if>>角色</option>
								</select>
							</div>
					...
					<%--<input type="text" name="param" value="${user.param}" class="layui-input" placeholder="请输入关键字">
						...
						<thead>
							<tr class="th-center">
								<%--<th><input name="" lay-skin="primary" lay-filter="allChoose" type="checkbox"></th>--%>
									...
									<th>角色<img id="role_name" onclick="sort(this);" src="${ctx}/static/images/doup.png" alt=""></th>
									<th>状态<img id="u.status" onclick="sort(this);" src="${ctx}/static/images/doup.png" alt=""></th>
									<th>操作</th>
								<%--<th style="text-align: center;"><img id="user_name" onclick="sort(this);" src="${ctx}/static/images/doup.png" alt=""><a id="user_name" onclick="sort(this);" style="cursor: pointer;font-weight: bold;">姓名</a></th>
						        <th style="text-align: center;"><a id="user_account" onclick="sort(this);" style="cursor: pointer;font-weight: bold;">账号</a></th>
						        <th style="text-align: center;"><a id="sex" onclick="sort(this);" style="cursor: pointer;font-weight: bold;">性别</a></th>
						        <th style="text-align: center;"><a id="phone" onclick="sort(this);" style="cursor: pointer;font-weight: bold;">手机号</a></th>
						        <th style="text-align: center;"><a id="id_card" onclick="sort(this);" style="cursor: pointer;font-weight: bold;">身份证</a></th>
						        <th style="text-align: center;"><a id="role_name" onclick="sort(this);" style="cursor: pointer;font-weight: bold;">角色</a></th>
						       	<th style="text-align: center;"><a id="u.status" onclick="sort(this);" style="cursor: pointer;font-weight: bold;">状态</a></th>
						...
						<tbody>
                           <c:forEach items="${users.list}" var="user" varStatus="status">
                               <tr>
                                   ...
                                   <td style="text-align: center;">${user.userAccount}</td>
                                   <td style="text-align: center;">
	                                   <c:if test="${user.sex == 0}">女</c:if>
		                               <c:if test="${user.sex == 1}">男</c:if>
                                   </td>
                                   <td style="text-align: right;">${user.phone}</td>
								   <td style="text-align: right;">${user.idCard}</td>
								   <td style="text-align: right;">${user.roleName}</td>
                                   <td style="text-align: center;">
