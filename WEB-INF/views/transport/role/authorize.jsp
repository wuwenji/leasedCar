                ...
                <table class="layui-form layui-table">
                    ...
                    <c:if test="${fn:length(menu.childMenus) > 0}">
                        <c:forEach items="${menu.childMenus}" var="childMenu">
                            <tr>
                                <td>
                                    <input class="aaa1" name="singleCheck" lay-skin="primary" lay-filter="singleChoose"
                                           type="checkbox"
                                           <c:if test="${fn:contains(menuIds, childMenu.id)}">checked</c:if>
                                           value="${childMenu.id}">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.state) {
                        ...
                        layer.msg('保存成功。。。', {icon: 16, time: 1000});
