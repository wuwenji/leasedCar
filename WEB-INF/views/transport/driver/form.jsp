    ...
    <form id="saveOrUpdate" class="layui-form" action="${ctx}/transport/driver/saveOrUpdate" method="post"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="phone" id="phone" value="${driver.phone}" lay-verify="phone|checkPhone"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="width: 100px;">
                    ...
                    <c:if test="${empty updateType || updateType =='1'}">
                           onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'workLicenseInvalid\')}'})"
                    </c:if>
                    <c:if test="${not empty updateType || updateType !='1'}">
                           readonly="readonly"
                    </c:if>
                ...
                <div class="layui-input-inline">
                    ...
                    <div class="upload">
                        ...
                        <i class="icon-cloud-upload" style="cursor:pointer;">
                            ...
                            <input class="upload-button" id="workLicenseFile" name="workLicenseFile"  type="file"
                                    <c:if test="${empty updateType || updateType =='1'}">
                                        onchange="previewImg(this);"
                                    </c:if>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="width: 100px;">
                    ...
                    <c:if test="${empty updateType || updateType =='2'}">
                           onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'drivingLicenseInvalid\')}'})"
                    </c:if>
                    <c:if test="${not empty updateType || updateType !='2'}">
                           readonly="readonly"
                    </c:if>
                ...
                <div class="layui-input-inline">
                    ...
                    <div class="upload">
                        ...
                        <i class="icon-cloud-upload" style="cursor:pointer;">
                            ...
                            <input  class="upload-button" id="drivingLicenseFile" name="drivingLicenseFile" type="file"
                                    <c:if test="${empty updateType || updateType =='2'}">
                                        onchange="previewImg(this);"
                                    </c:if>
                            />
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if (message != null && "" != message) {
            ...
            setTimeout(function () {
                parent.layer.msg(msg[0], {icon: msg[1], time: 1000}, function () {
                    parent.selfSubmit();
                });
            }, 100);
        }
