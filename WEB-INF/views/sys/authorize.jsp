                    ...
                    <tr>
                        <th>
                            <input name="" lay-skin="primary" lay-filter="allChoose" type="checkbox"
                                   <c:set value=",${menu.id}," var="s"></c:set>
                                   <c:if test="${fn:contains(menuIds, s)}">checked</c:if> value="${menu.id}">
                            ...
                            <tr>
                                <td>
                                    <input class="aaa1" name="singleCheck" lay-skin="primary" lay-filter="singleChoose" type="checkbox"
                                        <c:set value=",${childMenu.id}," var="s"></c:set>
                                           <c:if test="${fn:contains(menuIds, s)}">checked</c:if> value="${childMenu.id}">
